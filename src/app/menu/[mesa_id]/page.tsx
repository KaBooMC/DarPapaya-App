...
const MOCK_PRODUCTS = [
  ...
  { id: 'c4', nombre: 'Pollo Ajonjolí', precio: 19900, categoria: 'carnes', destino: 'cocina', desc: 'Pechuga apanada en Panko bañada en miel de soya y servida con papas criollas tempura.', img_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Sesame_chicken.jpg/800px-Sesame_chicken.jpg' },
  { id: 'c5', nombre: 'Arroz Nikkei', precio: 22900, categoria: 'carnes', destino: 'cocina', desc: 'Lomo salteado al wok con cebollas, tomates y papas criollas tempura sobre arroz chaufa.', img_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Arroz_chaufa.jpg/800px-Arroz_chaufa.jpg' },
  ...
  { id: 'p5', nombre: 'Arroz Caldoso', precio: 29900, categoria: 'pescados', destino: 'cocina', desc: 'Mezcla de pescado, muelitas de cangrejo, calamar y camarón, flameados en ron.', img_url: 'https://images.unsplash.com/photo-1534080564583-6be75777b70a?q=80&w=2000' },
  { id: 'p6', nombre: 'Pescado Blanco Pesto-Thai', precio: 29900, categoria: 'pescados', destino: 'cocina', desc: 'Filete de pescado con salsa de pesto, chile y lulo, yucas fritas, camarones y naranja.', img_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Fried_fish_with_chili_sauce.jpg/800px-Fried_fish_with_chili_sauce.jpg' },
  ...
  { id: 'e5', nombre: 'Chicharrón Enroscado', precio: 12900, categoria: 'entradas', destino: 'cocina', desc: 'Acompañado de piña salteada y salsa de jengibre, miso y cilantro.', img_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Chicharrones_Costa_Rica.jpg/800px-Chicharrones_Costa_Rica.jpg' },
  ...
  // CEVICHES & TIRADITOS
  { id: 'v1', nombre: 'Ceviche Del Chef', precio: 13900, categoria: 'ceviches', destino: 'cocina', desc: 'Cebollas dulce curada, aguacate, limón, mango pintón, aceite de oliva y cilantro.', img_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Ceviche_de_pescado_-_D%27Talia.jpg/800px-Ceviche_de_pescado_-_D%27Talia.jpg' },
  { id: 'v2', nombre: 'Ceviche Mexicano', precio: 13900, categoria: 'ceviches', destino: 'cocina', desc: 'Puré de tomates asados, cebolla blanca, aguacate, limón, cilantro y chipotle.', img_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Ceviche_de_camaron.jpg/800px-Ceviche_de_camaron.jpg' },
  { id: 'v3', nombre: 'Ceviche Nikkei', precio: 13900, categoria: 'ceviches', destino: 'cocina', desc: 'Cebolla roja, jengibre, salsa nikkei, limón, cilantro y ajonjolí.', img_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Ceviche_Peru.jpg/800px-Ceviche_Peru.jpg' },
  { id: 'v4', nombre: 'Ceviche Caribeño', precio: 13900, categoria: 'ceviches', destino: 'cocina', desc: 'Suero costeño, platanitos maduros, chorizo frito, cebolla curada y limón.', img_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Ceviche_con_patacones.jpg/800px-Ceviche_con_patacones.jpg' },
  { id: 't1', nombre: 'Tiradito Ají Amarillo', precio: 10900, categoria: 'ceviches', destino: 'cocina', desc: 'Tiras de pescado bañadas en salsa suave de ají amarillo y cilantro.', img_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Tiradito_de_pescado.jpg/800px-Tiradito_de_pescado.jpg' },
