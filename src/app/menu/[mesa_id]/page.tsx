...
const MOCK_PRODUCTS = [
  ...
  { id: 'p6', nombre: 'Pescado Blanco Pesto-Thai', precio: 29900, categoria: 'pescados', destino: 'cocina', desc: 'Filete de pescado con salsa de pesto, chile y lulo, yucas fritas, camarones y naranja.', img_url: 'https://images.unsplash.com/photo-1510425464197-8da771f28b49?q=80&w=2000' },
  ...
  { id: 'v2', nombre: 'Ceviche Mexicano', precio: 13900, categoria: 'ceviches', destino: 'cocina', desc: 'Puré de tomates asados, cebolla blanca, aguacate, limón, cilantro y chipotle.', img_url: 'https://images.unsplash.com/photo-1585805544716-160de64dd8b9?q=80&w=2000' },
  { id: 'v3', nombre: 'Ceviche Nikkei', precio: 13900, categoria: 'ceviches', destino: 'cocina', desc: 'Cebolla roja, jengibre, salsa nikkei, limón, cilantro y ajonjolí.', img_url: 'https://images.unsplash.com/photo-1559400262-113aa090289e?q=80&w=2000' },
  { id: 'v4', nombre: 'Ceviche Caribeño', precio: 13900, categoria: 'ceviches', destino: 'cocina', desc: 'Suero costeño, platanitos maduros, chorizo frito, cebolla curada y limón.', img_url: 'https://images.unsplash.com/photo-1555569472-ed3a8c1deab9?q=80&w=2000' },
  { id: 't1', nombre: 'Tiradito Ají Amarillo', precio: 10900, categoria: 'ceviches', destino: 'cocina', desc: 'Tiras de pescado bañadas en salsa suave de ají amarillo y cilantro.', img_url: 'https://images.unsplash.com/photo-1501595155459-28c08fc0f8fc?q=80&w=2000' },
