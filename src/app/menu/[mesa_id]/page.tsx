...
const MOCK_PRODUCTS = [
  ...
  { id: 'c4', nombre: 'Pollo Ajonjolí', precio: 19900, categoria: 'carnes', destino: 'cocina', desc: 'Pechuga apanada en Panko bañada en miel de soya y servida con papas criollas tempura.', img_url: 'https://images.unsplash.com/photo-1610970881699-44a5587cab84?auto=format&fit=crop&w=800&q=80' },
  { id: 'c5', nombre: 'Arroz Nikkei', precio: 22900, categoria: 'carnes', destino: 'cocina', desc: 'Lomo salteado al wok con cebollas, tomates y papas criollas tempura sobre arroz chaufa.', img_url: 'https://images.unsplash.com/photo-1588636906208-8df0e7b77ab6?auto=format&fit=crop&w=800&q=80' },
