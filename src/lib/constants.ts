...
export const MOCK_PRODUCTS = [
  ...
  { id: 't3', nombre: 'Tamal Valluno', precio: 14.50, categoria: 'tipicos', destino: 'cocina', desc: 'Masa de maíz rellena de carne de cerdo, pollo, zanahoria y patatas.', img_url: 'https://lh3.googleusercontent.com/gps-cs-s/AHVAwer6aElDTAixlBIMU6wRM4lQvrTc3ZIb4amsGkhwRMVcGaSVE40fPBXGciEGFJ-6N40YpPW7MnCDK6wjE2OlIrZ1NogqRtrnBMzbOAYQtTEuSZAZFmBpsKsT203PLoU48SAlotXxbA=w640-h640-n-k-no' },
  ...
  { id: 'b4', nombre: 'Cerveza Colombiana', precio: 4.00, categoria: 'bebidas', destino: 'bar', desc: 'Cerveza típica de nuestra tierra.', img_url: 'https://lh3.googleusercontent.com/gps-cs-s/AHVAweoXFYPnccfjPpACB1PxkSx8dxCD3J4lyUceSNQYxQgcFfI4hcnfG7ahGqt2OMatU3thNpnh0sBIydNbDuf82hb7x1ST3zXiRl0X3hN2glaKipQYtfoSILu0Ncul7sYrjJskxD3E=s1360-w1360-h1020-rw' },
